        ...
        <div class="col-sm-3">
          <div class="sub-total border text-center mt-2">
            ...
            <div class="border-top py-4">
              <h5 class="font-baloo font-size-20">Subtotal (<?php echo count($subTotal) ?? 0; ?> items): &nbsp;<span class="text-danger">$ <span class="text-danger" id="deal-price"><?php echo isset($subTotal) ? $Cart->getSum($subTotal) : 0; ?></span></span></h5>
