    ...
    <div class="row">
      ...
      <div class="col-sm-6 py-5">
        ...
        <div class="d-flex">
          ...
          <a href="#" class="px-2 font-rale font-size-14">20,534 ratings | 1000+ answered</a>
        </div>
        <hr class="m-0">
      ...
      <div class="col-12">
        ...
        <hr>
        <p class="font-rale font-size-14">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt quaerat aperiam asperiores, recusandae accusamus molestias quas fugiat quasi quae quis voluptates doloribus architecto culpa nemo. Necessitatibus inventore itaque iusto vero!</p>
        <p class="font-rale font-size-14">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt quaerat aperiam asperiores, recusandae accusamus molestias quas fugiat quasi quae quis voluptates doloribus architecto culpa nemo. Necessitatibus inventore itaque iusto vero!</p>
      </div>
    </div>
  </div>
